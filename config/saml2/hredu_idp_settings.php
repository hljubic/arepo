...
return $settings = array(
    ...
    'sp' => array(
        ...
        'x509cert' => base_path() . '/keys/osaa.crt',
        'privateKey' => base_path() . '/keys/osaa.pem',
    ...
    'idp' => array(
        ...
        'x509cert' => 'file://' . base_path() . '/keys/osaa.crt',
        'privateKey' => 'file://' . base_path() . '/keys/osaa.pem',
